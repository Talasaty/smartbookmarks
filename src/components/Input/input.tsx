...
export const Input: React.SFC<Props> = ({iconLeft, iconRight, backgroundColor, borderColor, color}) => (
    <InputContainer backgroundColor={backgroundColor} borderColor={borderColor}>
        ...
        { iconRight && <RightIcon src={iconRight} backgroundColor={backgroundColor}/>}
    </InputContainer>
)
